...
<?php drawSidebar('sidebar_formt','format_xgl'); ?>
...
<p>
  <a href="http://people.scs.fsu.edu/%7Eburkardt/data/xgl/xgl.html">
  XGL format information and examples</a> from John Burkardt
</p>
<hr>

<h3><?php echo $file_ext; ?> support notes inside IVCon source code:</h3>
<p>
<?php printCodeComment($home_path."/src/xgl.cpp",256); ?>
</p>
