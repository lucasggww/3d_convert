...
<?php drawSidebar('sidebar_formt','format_ucd'); ?>
...
<p>
  <a href="http://people.scs.fsu.edu/%7Eburkardt/data/ucd/ucd.html">
  UCD format information and examples</a> from John Burkardt
</p>
<hr>

<h3><?php echo $file_ext; ?> support notes inside IVCon source code:</h3>
<p>
<?php printCodeComment($home_path."/src/ucd.cpp",256); ?>
</p>
