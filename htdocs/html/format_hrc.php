...
<?php drawSidebar('sidebar_formt','format_hrc'); ?>
...
<p>
  <a href="http://people.scs.fsu.edu/%7Eburkardt/data/hrc/hrc.html">
  HRC format information and examples</a> from John Burkardt
</p>
<hr>

<h3><?php echo $file_ext; ?> support notes inside IVCon source code:</h3>
<p>
<?php printCodeComment($home_path."/src/hrc.cpp",256); ?>
</p>
